...
Object.defineProperties(game.Block, { cid: { configurable: true, get: function() { delete game.Block.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Block.cid = Module._ut_component_register_cid(/*game.Block*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::Block"*/, 0, 0); } } });
...
Object.defineProperties(game.ButtonInfo, { cid: { configurable: true, get: function() { delete game.ButtonInfo.cid; var offsetsPtr = 0, offsetsCount = 0; return game.ButtonInfo.cid = Module._ut_component_register_cid(/*game.ButtonInfo*/ 1, 1, 0, offsetsPtr, offsetsCount, 0/*"game::ButtonInfo"*/, 0, 0); } } });
...
Object.defineProperties(game.InputSystem, { cid: { configurable: true, get: function() { delete game.InputSystem.cid; var offsetsPtr = 0, offsetsCount = 0; return game.InputSystem.cid = Module._ut_component_register_cid(/*game.InputSystem*/ 12, 4, 0, offsetsPtr, offsetsCount, 0/*"game::InputSystem"*/, 0, 0); } } });
...
Object.defineProperties(game.MoveBlock, { cid: { configurable: true, get: function() { delete game.MoveBlock.cid; var offsetsPtr = 0, offsetsCount = 0; return game.MoveBlock.cid = Module._ut_component_register_cid(/*game.MoveBlock*/ 8, 4, 0, offsetsPtr, offsetsCount, 0/*"game::MoveBlock"*/, 0, 0); } } });
...
Object.defineProperties(game.Player, { cid: { configurable: true, get: function() { delete game.Player.cid; var offsetsPtr = ut.tempHeapPtrI32([0,8,16,24]); var offsetsCount = 4; return game.Player.cid = Module._ut_component_register_cid(/*game.Player*/ 32, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Player"*/, 0, 0); } } });
...
Object.defineProperties(game.Score, { cid: { configurable: true, get: function() { delete game.Score.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Score.cid = Module._ut_component_register_cid(/*game.Score*/ 4, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Score"*/, 0, 0); } } });
...
Object.defineProperties(game.Spawner, { cid: { configurable: true, get: function() { delete game.Spawner.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Spawner.cid = Module._ut_component_register_cid(/*game.Spawner*/ 8, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Spawner"*/, 0, 0); } } });
