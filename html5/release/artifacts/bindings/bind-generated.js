...
game.InputSystem = function(arg0, arg1, arg2) {
...
Object.defineProperties(game.InputSystem, { cid: { configurable: true, get: function() { delete game.InputSystem.cid; var offsetsPtr = 0, offsetsCount = 0; return game.InputSystem.cid = Module._ut_component_register_cid(/*game.InputSystem*/ 8, 4, 0, offsetsPtr, offsetsCount, 0/*"game::InputSystem"*/, 0, 0); } } });
...
Object.defineProperties(game.Player, { cid: { configurable: true, get: function() { delete game.Player.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Player.cid = Module._ut_component_register_cid(/*game.Player*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::Player"*/, 0, 0); } } });
