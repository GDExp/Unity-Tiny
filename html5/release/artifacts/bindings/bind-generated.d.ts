declare namespace entities.game.BlocksGroup {
...
class Block extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Block): Block;
  static _toPtr(p: number, v: Block): void;
...
class InputSystem extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: InputSystem): InputSystem;
  static _toPtr(p: number, v: InputSystem): void;
  static _tempHeapPtr(v: InputSystem): number;
  static _dtorFn(v: InputSystem): void;
}

}
declare namespace game {

class MoveBlock extends ut.Component {
  constructor(blockSpeed?: number, move?: boolean, setup?: boolean);
  blockSpeed: number;
  move: boolean;
  setup: boolean;
  static readonly blockSpeed: ComponentFieldDesc;
  static readonly move: ComponentFieldDesc;
  static readonly setup: ComponentFieldDesc;
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;

  static _size: number;
  static _fromPtr(p: number, v?: MoveBlock): MoveBlock;
  static _toPtr(p: number, v: MoveBlock): void;
  static _tempHeapPtr(v: MoveBlock): number;
  static _dtorFn(v: MoveBlock): void;
}
...
class Score extends ut.Component {
  ...
  Scores: number;
  static readonly Scores: ComponentFieldDesc;
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;
...
class Spawner extends ut.Component {
  constructor(isPaused?: boolean, plusSpeed?: number);
  isPaused: boolean;
  plusSpeed: number;
  static readonly isPaused: ComponentFieldDesc;
  static readonly plusSpeed: ComponentFieldDesc;
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;
...
declare namespace game {
var PlayerInputJS: ut.SystemJS;
}
declare namespace game {
var ScoreSystemJS: ut.SystemJS;
}
declare namespace game {
var SpawnerSystemsJS: ut.SystemJS;
}
